...
function ProcedureTask(AProcedure: TTaskProcedure): TTask; overload;
function ProcedureTask(AProcedure: TTaskMethodProcedure): TTask; overload;
generic function ProcedureTask<TParam1>(
...
generic function ProcedureTask<TParam1>(
  ...
  AParam1: TParam1): TTask; overload;
generic function ProcedureTask<TParam1, TParam2>(
...
generic function ProcedureTask<TParam1, TParam2>(
  ...
  AParam1: TParam1; AParam2: TParam2): TTask; overload;
generic function ProcedureTask<TParam1, TParam2, TParam3>(
...
generic function ProcedureTask<TParam1, TParam2, TParam3>(
  ...
  AParam1: TParam1; AParam2: TParam2; AParam3: TParam3): TTask; overload;
generic function ProcedureTask<TParam1, TParam2, TParam3, TParam4>(
...
generic function FunctionTask<TResult>(
...
generic function FunctionTask<TResult, TParam1>(
...
generic function FunctionTask<TResult, TParam1>(
  ...
  AParam1: TParam1): specialize TRVTask<TResult>; overload;
generic function FunctionTask<TResult, TParam1, TParam2>(
...
generic function FunctionTask<TResult, TParam1, TParam2>(
  ...
  AParam1: TParam1; AParam2: TParam2): specialize TRVTask<TResult>; overload;
generic function FunctionTask<TResult, TParam1, TParam2, TParam3>(
...
generic function FunctionTask<TResult, TParam1, TParam2, TParam3>(
  ...
  AParam1: TParam1; AParam2: TParam2; AParam3: TParam3): specialize TRVTask<TResult>; overload;
generic function FunctionTask<TResult, TParam1, TParam2, TParam3, TParam4>(
...
function ProcedureTask(AProcedure: TTaskProcedure): TTask;
begin
  Result := TProcedureTask.Create(AProcedure);
end;

function ProcedureTask(AProcedure: TTaskMethodProcedure): TTask;
begin
